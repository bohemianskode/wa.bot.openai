...
## BACA DULU Sebelum MenggunakanNya..
Terdapat 2 fitur yaitu ```ChatGPT(text)``` dan ```DALL-E(Text To Image).```<br>Untuk commandnya menggunakan ```/ai``` dan ```/img```

## Get & Change OpenAI ApiKey (Daftar OpenAI dengan Akun Google Anda, Kemudian Klik Link nya)
...
## Install (Menjalankan Di Windows dengan MinGW Shell/CMD)
...
![74a01ced-639e-4c7e-a993-d9efae49fd48](https://user-images.githubusercontent.com/68543155/222844808-a6f4f87f-c233-4138-9227-f54cd6c85416.jpg)
